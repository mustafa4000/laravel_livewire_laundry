                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif ($item->status == 1)
                                    <span class="badge bg-dark">Dicuci</span>
                                @elseif ($item->status == 2)
                                    <span class="badge bg-primary">Dikeringkan</span>
                                @elseif ($item->status == 3)
                                    <span class="badge bg-info">Disetrika</span>
                                @elseif ($item->status == 4)
                                    <span class="badge bg-warning">Menunggu Dibayar</span>
